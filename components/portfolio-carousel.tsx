...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      "Professional website with AI booking assistant for a growing plumbing business, featuring online scheduling and 24/7 customer support automation.",
    role: "Small Business Web Development & AI Integration",
    services: ["Custom Website", "AI Booking Bot", "Local SEO"],
    image: "/placeholder.svg?height=400&width=600&text=Local+Plumbing+Services+Website",
    url: "https://plumbing-demo.com",
  },
  {
    id: 2,
    name: "Boutique Coffee Shop",
    description:
      "E-commerce enabled website with AI customer service for a local coffee roaster, including online ordering and automated customer support.",
    role: "Small Business E-commerce & AI Automation",
    services: ["E-commerce Site", "AI Customer Support", "Order Management"],
    image: "/placeholder.svg?height=400&width=600&text=Boutique+Coffee+Shop+Website",
    url: "https://coffee-demo.com",
  },
  {
    id: 3,
    name: "Family Dental Practice",
    description:
      "Modern practice website with AI appointment scheduling and patient communication system, streamlining operations for a busy dental office.",
    role: "Healthcare Small Business & AI Scheduling",
    services: ["Professional Website", "AI Appointment Bot", "Patient Portal"],
    image: "/placeholder.svg?height=400&width=600&text=Family+Dental+Practice+Website",
    url: "https://dental-demo.com",
  },
]
